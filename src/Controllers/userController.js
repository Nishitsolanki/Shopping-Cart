...
const registerUser = async function (req, res) {
    try {
        ...
        //_________Validation for First Name_______________
        ...
        //__________Validation of Last Name__________________
        ...
        //_____________Validation for Email_________________
        ...
        //_____________Validation for mobile__________________
        ...
        //____________Validation for Password__________________
        ...
        //____________If address field is not given_________________
        ...
        //______Encrypting Password_____________
...
const updateuser = async function (req, res) {
    ...
    if (fname || lname || email || phone || password || address) {
        ...
        if (email) {
            ...
            //______Checking duplicate email_____________
        ...
        if (phone) {
            ...
            //_________Checking duplicate phone________________
  ...
  //====================================Updating Profile=====================================================================================================================================================================
    const update = await userModel.findOneAndUpdate({id : user},{$set : obj},{new : true}).select({_v : 0})
    if (!update) {
